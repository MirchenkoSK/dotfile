...
def show_banner() -> None:
    print_center(
        '\u001B[31m' r' _____ _____ __    _____ ____ _____ __ __ _____ __ __ __ __ ',
        '\u001B[31m' r'| | | |     | |   |  ___| __ \  _  |  |  |_   _|  |  |  |  |',
        '\u001B[33m' r'|     |  -  | |___|  _| |    <     |     |_| |_|  |  |     |',
        '\u001B[33m' r'|__|__|_____|_____|_|   |_|__|__|__|_|_|_|_____|_____|_|_|_|',
    )

    print_center(
        '\u001B[34m' r' ____ __ __ ____ _____ _____ __ __ ',
        '\u001B[34m' r'| ___|  |  | ___|_   _|  ___|  |  |',
        '\u001B[36m' r'|___ |\   /|___ | | | |  ___|     |',
        '\u001B[36m' r'|____| |_| |____| |_| |_____|_|_|_|',
    )
